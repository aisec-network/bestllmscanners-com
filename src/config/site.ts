...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Find the right scanner before attackers find you." },
...
export const siteConfig: SiteConfig = {
  domain: "bestllmscanners.com",
  url: "https://bestllmscanners.com",
  title: "Best LLM Scanners",
  tagline: "Comparing LLM security scanners and detection tools.",
  description:
    "Practitioner comparisons of LLM security scanners. Garak, PyRIT, promptmap, vendor LLM-specific scanners — coverage gaps, false-positive profiles, integration cost, and the cases where 'best' depends on what you're actually defending.",
  byline: "Best LLM Scanners Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 130, cluster: "defensive" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@bestllmscanners.com",
    abuse: "abuse@bestllmscanners.com",
    editor: "editor@bestllmscanners.com",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "bestllmscanners.com"),
  analytics: {},
};
