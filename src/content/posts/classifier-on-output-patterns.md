...
The bigger cost is operational. Output classifiers need eval sets, regression monitoring, and a tuning loop for false positives. The next post in this series gets specific about how to measure that: [False Positive Cost in Production Refusal Systems: How to Measure and Tune](/posts/false-positive-cost-refusal-tuning/).
